...
/*
 * Description of the parameters used for NTG
 * TODO: convert to Sphinx compatible form
 *
 ...
 * constrAV, nconstrAV: the "active" variables used in evaluating the constraints.
 *
 ...
 * R (double *): an array length ncoef*ncoef
 *
 */
